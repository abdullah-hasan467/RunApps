...
function DeliveriesScreen() {
  return (
    <View style={styles.deliveriesContainer}>
      ...
      <Text style={styles.textDelivary}>
        Wait until your friends have added their items to the group order cart,
        and the ready icon has appeared by their names.
      </Text>
